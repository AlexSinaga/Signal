    ...
    builder.setItems(R.array.mute_durations, new DialogInterface.OnClickListener() {
      ...
      public void onClick(DialogInterface dialog, final int which) {
        ...
        switch (which) {
          ...
          case 4:  muteUntil = System.currentTimeMillis() + TimeUnit.DAYS.toMillis(30); break;
          case 5:  muteUntil = System.currentTimeMillis() + TimeUnit.DAYS.toMillis(182); break;
          case 6:  muteUntil = System.currentTimeMillis() + TimeUnit.DAYS.toMillis(365); break;
          case 7:  muteUntil = Long.MAX_VALUE;                                           break;
